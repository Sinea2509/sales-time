...
-- CreateEnum
CREATE TYPE "UserProfileRole" AS ENUM ('COMMERCIAL', 'SALES_MANAGER', 'LEADERSHIP', 'OTHER');
...
-- CreateIndex
CREATE INDEX "SuperAdminAuditLog_organizationId_idx" ON "SuperAdminAuditLog"("organizationId");

-- CreateIndex
CREATE INDEX "Person_organizationId_idx" ON "Person"("organizationId");

-- CreateIndex
CREATE UNIQUE INDEX "Person_organizationId_normalizedKey_key" ON "Person"("organizationId", "normalizedKey");
...
-- CreateIndex
CREATE INDEX "Meeting_organizationId_sellerUserId_idx" ON "Meeting"("organizationId", "sellerUserId");
