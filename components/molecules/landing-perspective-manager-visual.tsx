    ...
    <div className="overflow-hidden rounded-2xl border border-zinc-200 shadow-[0_8px_40px_rgba(0,0,0,0.07)]">
      <div className="bg-zinc-50 p-5">
        <div className="mb-4 flex items-center justify-between">
          <p className="text-[13px] font-semibold text-zinc-950">Vue Manager · Équipe</p>
        ...
        <div className="mb-3 grid grid-cols-2 gap-2">
          ...
          <div className="rounded-[7px] border border-zinc-200 bg-white p-2.5">
            ...
            <p className="text-base font-bold tracking-tight text-zinc-950">165</p>
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          {teamRows.map((row) => (
            <div
              key={row.name}
              className="flex items-center gap-2 rounded-[7px] border border-zinc-200 bg-white px-2.5 py-2"
            >
              <span
              ...
              <div className="min-w-0 flex-1">
                <p className="text-[11px] font-medium text-zinc-950">{row.name}</p>
                <p className="text-[9.5px] text-zinc-500">{row.subtitle}</p>
              </div>
              <p className="text-[11px] font-bold text-zinc-950">{row.score}</p>
            </div>
          ))}
        </div>
      </div>
