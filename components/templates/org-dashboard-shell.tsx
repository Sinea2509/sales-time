    ...
    <SidebarProvider defaultOpen>
      <Sidebar collapsible="icon" side="left" variant="sidebar">
        <SidebarHeader className="border-b border-sidebar-border">
          ...
          >
            <span className="bg-sidebar-primary text-sidebar-primary-foreground flex h-8 w-8 items-center justify-center rounded-lg text-xs">
              ST
            </span>
        ...
        <SidebarContent>
          <SidebarGroup>
            ...
            <SidebarGroupContent className="px-0">
              ...
              {!activeTenantClerkOrgId ? (
                <p className="text-sidebar-foreground/70 group-data-[collapsible=icon]:hidden px-2 pb-2 text-xs leading-snug">
