...
export function LandingTestimonialSection() {
  ...
  return (
    <section
      id="testi"
      className="scroll-mt-24 bg-muted py-[88px]"
      ...
      <div className="mx-auto max-w-[860px] px-6 sm:px-10">
        <LandingReveal>
          <div className="text-center">
            ...
            <blockquote className="text-[clamp(22px,2.8vw,34px)] leading-[1.45] font-semibold tracking-tight text-pretty text-foreground">
            ...
            <div className="mt-[52px] flex flex-col border-y border-border sm:flex-row">
              {stats.map((stat) => (
                <div
                  key={stat.label}
                  className="flex-1 border-b border-border px-6 py-7 text-center last:border-b-0 sm:border-r sm:border-b-0 sm:last:border-r-0"
                >
